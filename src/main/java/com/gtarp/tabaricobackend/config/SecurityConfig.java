    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/stocks/**").hasAnyRole("CDI","Responsable","Patron","Rh")
                        .requestMatchers(HttpMethod.POST, "/stocks/**").hasAnyRole("CDI","Responsable","Patron","Rh")
                        .requestMatchers(HttpMethod.PUT, "/users/change-password").permitAll()
                        .requestMatchers(HttpMethod.GET, "/users/**").hasAnyRole("Rh", "Patron")
                        .requestMatchers(HttpMethod.POST, "/users/**").hasAnyRole("Rh", "Patron")
                        .requestMatchers(HttpMethod.PUT, "/users/**").hasAnyRole("Rh", "Patron")
                        .requestMatchers(HttpMethod.DELETE, "/users/**").hasAnyRole("Rh", "Patron")
                        .requestMatchers(HttpMethod.GET, "/personalDashboard/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/dashboard/**").hasAnyRole("Responsable", "Patron","Rh")
                        .requestMatchers(HttpMethod.PUT, "/dashboard/**").hasAnyRole("Responsable", "Patron","Rh")
